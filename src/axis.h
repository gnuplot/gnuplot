...
typedef enum e_timelevel {
    ...
    TIMELEVEL_DAYS, TIMELEVEL_WEEKS, TIMELEVEL_MONTHS, TIMELEVEL_YEARS
} t_timelevel;
...
/* time/date axis control */
    ...
    t_timelevel tic_units;	/* granularity of auto-generated time tics */
...
#define DEFAULT_AXIS_STRUCT {						    \
	...
	TIMELEVEL_SECONDS,	/* default granularity (seconds) for tics */\
