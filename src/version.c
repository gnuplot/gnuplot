#ifndef lint
static char *RCSid() { return RCSid("$Id: version.c,v 1.69.2.9 2007/06/02 22:31:34 mikulik Exp $"); }
#endif
...
const char gnuplot_patchlevel[] = "CVS-04Aug2007 ";
const char gnuplot_date[] = "Sat Aug  4 11:12:55 PDT 2007";
