#ifndef lint
static char *RCSid() { return RCSid("$Id: version.c,v 1.69.2.8 2007/03/03 06:22:13 sfeam Exp $"); }
#endif
...
const char gnuplot_patchlevel[] = "0cvs";
const char gnuplot_date[] = "June 2007";
