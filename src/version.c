#ifndef lint
static char *RCSid() { return RCSid("$Id: version.c,v 1.89.2.3 2010/01/25 07:59:33 mikulik Exp $"); }
#endif
...
const char gnuplot_patchlevel[] = "0-rc1";
const char gnuplot_date[] = "January 2010";
