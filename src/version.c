#ifndef lint
static char *RCSid() { return RCSid("$Id: version.c,v 1.18 1999/06/19 20:35:27 lhecking Exp $"); }
#endif
...
const char gnuplot_patchlevel[] = "0.9";
const char gnuplot_date[] = "Sat Jun 19 21:09:30 BST 1999";
