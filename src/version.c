#ifndef lint
static char *RCSid() { return RCSid("$Id: version.c,v 1.111.2.14 2016/07/21 19:00:31 sfeam Exp $"); }
#endif
...
const char gnuplot_patchlevel[] = "5pre";
#ifdef DEVELOPMENT_VERSION
#include "timestamp.h"
#else
const char gnuplot_date[] = "2016-09-07 ";
#endif
