#ifndef lint
static char *RCSid() { return RCSid("$Id: version.c,v 1.89.2.12 2011/08/29 16:49:18 sfeam Exp $"); }
#endif
...
const char gnuplot_date[] = "September 2011";
const char gnuplot_copyright[] = "Copyright (C) 1986-1993, 1998, 2004, 2007-2011";
