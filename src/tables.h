/*
 * $Id: tables.h,v 1.28 2002/03/09 22:41:45 mikulik Exp $
 */
...
enum set_id {
    ...
    S_DGRID3D, S_DUMMY, S_ENCODING, S_DECIMALSIGN, S_FORMAT, S_GRID,
    S_HIDDEN3D, S_HISTORYSIZE, S_ISOSAMPLES, S_KEY, S_KEYTITLE, S_LABEL,
