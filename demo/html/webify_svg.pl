...
# open pipe to gnuplot and set terminal type
	...
	if ((defined $ENV{DEMOTERM}) && $DEMOTERM ne "") {
	    ...
	    print GNUPLOT "set term svg enhanced font 'arial,10' mouse jsdir '.' size 600,400 dynamic\n";
	}
...
# Start processing
	...
	print OUT "<embed src=\"$ARGV[0].$plot.svg\" type=\"image/svg+xml\" width=600 height=400 class=\"float-right\">\n";
	print OUT "</td><td>\n";
