%
% $Id: titlepag.tex,v 1.10 2002/03/07 20:44:02 mikulik Exp $
%
...
\else
  \IfFileExists{../VERSION.}{\gdef\gpVersion{\input{../VERSION.}}}{\gdef\gpVersion{\input{../VERSION}}}
  \newbox\GpVersion \setbox\GpVersion=\hbox{\gpVersion}
  \gdef\gnuplotVersion{\usebox\GpVersion}
  Version
    \gnuplotVersion
  organized by: David Denholm \\
\fi
...
\else {
  ...
  Last edited: \ignoredate $Date: 2002/03/07 20:44:02 $
  }
\fi
...
\else
  \markboth{{\bf gnuplot} \gnuplotVersion}{{\bf gnuplot} \gnuplotVersion}
\fi
