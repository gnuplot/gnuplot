...
%       comment them out if you are using lualatex
%
   \usepackage{ucs}
...
%
%       These commands are for use with lualatex or xelatex
%       comment them out if you are using pdflatex
%
% Other usable fonts are Liberation Serif, Arno Pro, Quivira, Times New Roman
% The default CM fonts are missing too many unicode characters.characters.
%  \usepackage{fontspec}
%  \setmainfont{Free Serif}
%  \setmonofont{Free Mono}[Scale = 1.0]
