...
%
% $Id: faq-ja.tex,v 1.16 2007-02-18 17:53:11+09 shige Exp $
% translated to Japanese by Shigeharu TAKENO 2005/03/14
% Original: Id: faq.tex,v 1.28 2007/02/17 20:31:34 mikulik Exp
%
%
...
version 4.2 を取り扱っています。
        \\
% Its version is
% \verb+Revision: 1.28 +, dated
% \verb+Date: 2007/02/17 20:31:34 +.
% <== 本当は \verb++ の内側に $ がついている
この文書のバージョンは %
\verb+$+\verb+Revision: 1.28 $+,
\verb+$+\verb+Date: 2007/02/17 20:31:34 $+ です。
...
GIF のサポートは外部のライブラリである libgd (\http{www.libgd.org})
で与えられています。
...
%% table terminal:
他のやり方としては、等高線を table 出力形式を利用して一時ファイルに書き出す
手があります:
\begin{verbatim}
...
\subsection{\gnuplot{} 3.7, 4.0, 4.2 等で新しくなったことは}
...
OS/2 プレゼンテーションマネージャ (pm), X11, Windows, WX, GGI。
