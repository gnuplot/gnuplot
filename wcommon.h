/*
 * $Id: wcommon.h%v 3.50 1993/07/09 05:35:24 woo Exp $
 */
...
#if WINVER >= 0x030a
BOOL CALLBACK _export PrintAbortProc(HDC hdcPrn, int code);
BOOL CALLBACK _export PrintDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam);
#endif
