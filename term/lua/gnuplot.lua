--[[
  ...
  $Date: 2008-12-20 15:15:44 +0100 (Sa, 20. Dez 2008) $
  $Author: peter $
  $Rev: 90 $
...
pgf.REVISION_DATE = string.gsub("$Date: 2008-12-20 15:15:44 +0100 (Sa, 20. Dez 2008) $",
...
\def\gpdefrectangularnode#1#2#3{%
  ...
  \expandafter\edef\csname pgf@sh@nt@#1\endcsname{\pgf@temp}%
  \expandafter\edef\csname pgf@sh@pi@#1\endcsname{\pgfpictureid}%
}
