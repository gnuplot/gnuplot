...
%
% translated to Japanese by Shigeharu TAKENO (2020-01-18)
% Original: Id: faq.tex updated at 2019-12-29
%
...
まだ入っていない機能も入っています。
2019 年 12 月現在、開発版のバージョン 5.3 は、以下を特にサポートしています:
%% end Japanese
\begin{itemize}{}{}
...
\item 3 次元曲面の現在の zrange に対する滑らかなクリッピング
%% end Japanese
%% \item polygon objects and plot styles
\item 多角形 (polygon) の object と描画スタイル
%% end Japanese
...
現在の開発版は、特別な描画スタイル \textit{with polygons} をサポートし
ていて、これは多角形形状 (三角形、四辺形、八角形、...) を処理できますが、
以前のバージョンで、それを行う最も良い方法は、
以下のような形式で 3 次元物体の面に色をつけたものをファイルに記述する
ことです:
%% end Japanese
%%% \small
%%% \begin{verbatim}
