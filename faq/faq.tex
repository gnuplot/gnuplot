...
You may get an error message about "slow font initialization".
This is because it shares a font cache with other programs.
If you request a font that no one else is using, it takes longer to
...
cache can be empty.  Try invoking gnuplot with command line option {\em --slow}.
...
{\em awk -f addblanks.awk <a.dat} or plot the datafile under a unixish platform
